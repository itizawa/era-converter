...
//         encodeURIComponent('私は' + nengo + ' https://conversion-e6b5e.firebaseapp.com/') +
//         '&hashtags=年号コンバーター';
...
//     tweetUrl = 'https://twitter.com/intent/tweet?text=' + encodeURIComponent('私は') + '&hashtags=元号コンバーター';
